export const content = {
  fr: {
    ...
    temoignages: {
      ...
      items: [
        { nom: "Marie K.",photo: "/patients/marie-k.jpg", initiale: "M", lieu: "Bujumbura, Burundi", texte: "Grâce à HealthConnect, j'ai pu consulter un cardiologue depuis mon village sans me déplacer. Le médecin était professionnel et attentif. C'est un miracle pour nous qui vivons loin des grandes villes.", etoiles: 5 },
